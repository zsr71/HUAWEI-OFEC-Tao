...
Turbo_product<L, B, R, Q>::Turbo_product(const int argc, const char** argv, std::ostream& stream)
  : L(argc, argv, stream)
  , params_cdc(new factory::Codec_turbo_product("cdc"))
{
...
template<class L, typename B, typename R, typename Q>
void
Turbo_product<L, B, R, Q>::get_description_args()
{
...
template<class L, typename B, typename R, typename Q>
void
Turbo_product<L, B, R, Q>::store_args()
{
