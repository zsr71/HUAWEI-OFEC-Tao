...
Quantizer_pow2<R, Q>::Quantizer_pow2(const int N, const short& fixed_point_pos)
  : Quantizer<R, Q>(N)
...
template<typename R, typename Q>
Quantizer_pow2<R, Q>::Quantizer_pow2(const int N, const short& fixed_point_pos, const short& saturation_pos)
  : Quantizer<R, Q>(N)
...
template<typename R, typename Q>
Quantizer_pow2<R, Q>*
Quantizer_pow2<R, Q>::clone() const
{
