...
template<typename R>
Channel_user_bs<R>::Channel_user_bs(const int N, const std::string& filename)
...
template<typename R>
void
Channel_user_bs<R>::_add_noise(const float* /*CP*/, const R* X_N, R* Y_N, const size_t frame_id)
{
