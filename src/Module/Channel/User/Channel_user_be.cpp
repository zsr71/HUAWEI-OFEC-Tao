...
template<typename R>
Channel_user_be<R>::Channel_user_be(const int N, const std::string& filename)
...
template<typename R>
void
Channel_user_be<R>::_add_noise(const float* /*CP*/, const R* X_N, R* Y_N, const size_t frame_id)
{
