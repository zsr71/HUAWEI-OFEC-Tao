...
Monitor_MI<B, R>::Monitor_MI(const int N, const unsigned max_n_trials)
  : Monitor()
  , N(N)
  , max_n_trials(max_n_trials)
  , mutinfo_hist(1)
  , mutinfo_hist_activated(false)
{
    ...
    this->create_codelet(p,
                         [ps_X, ps_Y](spu::module::Module& m, spu::runtime::Task& t, const size_t frame_id) -> int
                         {
...
Monitor_MI<B, R>::clone() const
{
    ...
    if (this->callback_n_trials_limit_achieved.size())
    {
        ...
        message << "'callback_n_trials_limit_achieved.size()' has to be equal to 0 "
                << "('callback_n_trials_limit_achieved.size()' = " << this->callback_n_trials_limit_achieved.size()
                << ").";
        throw spu::tools::runtime_error(__FILE__, __LINE__, __func__, message.str());
    }
...
template<typename B, typename R>
bool
Monitor_MI<B, R>::equivalent(const Monitor_MI<B, R>& m, bool do_throw) const
{
    if (get_N() != m.get_N())
    {
        ...
        std::stringstream message;
        message << "'get_N()' is different than 'm.get_N()' ('get_N()' = " << get_N() << ", 'm.get_N()' = " << m.get_N()
                << ").";
        throw spu::tools::invalid_argument(__FILE__, __LINE__, __func__, message.str());
    }
...
template<typename B, typename R>
R
Monitor_MI<B, R>::get_mutual_info(const B* X, const R* Y, const int frame_id, const bool managed_memory)
{
...
Monitor_MI<B, R>::_get_mutual_info(const B* X, const R* Y, const size_t /*frame_id*/)
{
    ...
    if (this->n_trials_limit_achieved()) this->callback_n_trials_limit_achieved.notify();
...
template<typename B, typename R>
void
Monitor_MI<B, R>::add_MI_value(const R mi)
{
    vals.n_trials++;
    ...
    if (mutinfo_hist_activated) this->mutinfo_hist.add_value(mi);
}

template<typename B, typename R>
bool
Monitor_MI<B, R>::n_trials_limit_achieved() const
{
...
template<typename B, typename R>
bool
Monitor_MI<B, R>::is_done() const
{
    return n_trials_limit_achieved();
}

template<typename B, typename R>
const typename Monitor_MI<B, R>::Attributes&
Monitor_MI<B, R>::get_attributes() const
{
    return vals;
}
...
template<typename B, typename R>
unsigned
Monitor_MI<B, R>::get_max_n_trials() const
{
    return max_n_trials;
}
...
template<typename B, typename R>
unsigned long long
Monitor_MI<B, R>::get_n_trials() const
{
...
template<typename B, typename R>
R
Monitor_MI<B, R>::get_MI_min() const
{
    return vals.MI_min;
}
...
template<typename B, typename R>
R
Monitor_MI<B, R>::get_MI_max() const
{
    return vals.MI_max;
}
...
template<typename B, typename R>
tools::Histogram<R>
Monitor_MI<B, R>::get_mutinfo_hist() const
{
...
template<typename B, typename R>
void
Monitor_MI<B, R>::activate_mutinfo_histogram(bool val)
{
...
template<typename B, typename R>
uint32_t
Monitor_MI<B, R>::record_callback_check(std::function<void(void)> callback)
{
...
template<typename B, typename R>
uint32_t
Monitor_MI<B, R>::record_callback_n_trials_limit_achieved(std::function<void(void)> callback)
{
...
template<typename B, typename R>
bool
Monitor_MI<B, R>::unrecord_callback_check(const uint32_t id)
{
...
template<typename B, typename R>
bool
Monitor_MI<B, R>::unrecord_callback_n_trials_limit_achieved(const uint32_t id)
{
...
template<typename B, typename R>
void
Monitor_MI<B, R>::collect(const Monitor& m, bool fully)
{
...
template<typename B, typename R>
void
Monitor_MI<B, R>::collect(const Monitor_MI<B, R>& m, bool fully)
{
    collect(m.get_attributes());
    if (fully) this->mutinfo_hist.add_values(m.mutinfo_hist);
}

template<typename B, typename R>
void
Monitor_MI<B, R>::collect(const Attributes& v)
{
    vals += v;
}
...
template<typename B, typename R>
void
Monitor_MI<B, R>::copy(const Monitor& m, bool fully)
{
...
template<typename B, typename R>
void
Monitor_MI<B, R>::copy(const Monitor_MI<B, R>& m, bool fully)
{
    copy(m.get_attributes());
    if (fully) this->mutinfo_hist = m.mutinfo_hist;
}

template<typename B, typename R>
void
Monitor_MI<B, R>::copy(const Attributes& v)
{
    vals = v;
}
...
template<typename B, typename R>
typename Monitor_MI<B, R>::Attributes&
Monitor_MI<B, R>::Attributes ::operator+=(const Attributes& v)
{
    n_trials += v.n_trials;
...
template<typename B, typename R>
void
Monitor_MI<B, R>::Attributes ::reset()
{
    n_trials = 0;
    MI = 0.;
    MI_max = 0.;
...
template<typename B, typename R>
Monitor_MI<B, R>::Attributes ::Attributes()
{
    reset();
}
