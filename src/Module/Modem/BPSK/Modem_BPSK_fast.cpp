...
Modem_BPSK_fast<B, R, Q>::Modem_BPSK_fast(const int N, const bool disable_sig2)
  : Modem<B, R, Q>(N)
...
Modem_BPSK_fast<B, R, Q>::clone() const
{
...
Modem_BPSK_fast<B, R, Q>::_demodulate(const float* CP, const Q* Y_N1, Q* Y_N2, const size_t /*frame_id*/)
{
    ...
    else
    {
        ...
        if (*CP != this->last_channel_param) this->two_on_square_sigma = (R)2.0 / (*CP * *CP);
