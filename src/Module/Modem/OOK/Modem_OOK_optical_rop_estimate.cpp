...
Modem_OOK_optical_rop_estimate<B, R, Q>::Modem_OOK_optical_rop_estimate(const int N,
                                                                        const std::vector<size_t>& ROP_known_bits,
...
Modem_OOK_optical_rop_estimate<B, R, Q>::clone() const
{
...
template<typename B, typename R, typename Q>
void
Modem_OOK_optical_rop_estimate<B, R, Q>::init()
{
...
template<typename B, typename R, typename Q>
void
Modem_OOK_optical_rop_estimate<B, R, Q>::_demodulate_wg(const float* /*CP*/,
                                                        const R* X_N,
                                                        const Q* Y_N1,
                                                        Q* Y_N2,
