...
Decoder_BCH ::Decoder_BCH(const std::string& prefix)
...
void
Decoder_BCH ::get_description(cli::Argument_map_info& args) const
{
    ...
    tools::add_arg(args, p, class_name + "p+corr-pow,T", cli::Integer(cli::Positive(), cli::Non_zero()));
...
void
Decoder_BCH ::store(const cli::Argument_map_value& vals)
{
    Decoder::store(vals);
...
void
Decoder_BCH ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
...
Decoder_BCH ::build(const tools::BCH_polynomial_generator<B>& GF, module::Encoder<B>* encoder) const
{
    try
    {
    ...
    catch (spu::tools::cannot_allocate const&)
    {
        if (this->type == "ALGEBRAIC")
        {
            ...
            if (encoder)
            {
                if (this->implem == "GENIUS")
                    return new module::Decoder_BCH_genius<B, Q>(this->K, this->N_cw, this->t, *encoder);
            }
        }
    }
...
aff3ct::factory::Decoder_BCH::build<B_8, Q_8>(const aff3ct::tools::BCH_polynomial_generator<B_8>&,
                                              module::Encoder<B_8>*) const;
template aff3ct::module::Decoder_SIHO<B_16, Q_16>*
aff3ct::factory::Decoder_BCH::build<B_16, Q_16>(const aff3ct::tools::BCH_polynomial_generator<B_16>&,
                                                module::Encoder<B_16>*) const;
template aff3ct::module::Decoder_SIHO<B_32, Q_32>*
aff3ct::factory::Decoder_BCH::build<B_32, Q_32>(const aff3ct::tools::BCH_polynomial_generator<B_32>&,
                                                module::Encoder<B_32>*) const;
template aff3ct::module::Decoder_SIHO<B_64, Q_64>*
aff3ct::factory::Decoder_BCH::build<B_64, Q_64>(const aff3ct::tools::BCH_polynomial_generator<B_64>&,
                                                module::Encoder<B_64>*) const;
#else
template aff3ct::module::Decoder_SIHO<B, Q>*
aff3ct::factory::Decoder_BCH::build<B, Q>(const aff3ct::tools::BCH_polynomial_generator<B>&, module::Encoder<B>*) const;
#endif
// ==================================================================================== explicit template instantiation