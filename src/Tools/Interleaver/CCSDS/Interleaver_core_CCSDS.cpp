...
template<typename T>
Interleaver_core_CCSDS<T>::Interleaver_core_CCSDS(const int size)
...
Interleaver_core_CCSDS<T>::clone() const
{
...
template<typename T>
int
Interleaver_core_CCSDS<T>::pi_CCSDS(const int& index, const int& k_1, const int& k_2)
{
