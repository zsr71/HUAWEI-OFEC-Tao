...
bool
Modem_BPSK_fast<B, R, Q>::is_complex_mod()
{
    return false;
}
...
template<typename B, typename R, typename Q>
bool
Modem_BPSK_fast<B, R, Q>::is_complex_fil()
{
    return false;
}
...
template<typename B, typename R, typename Q>
int
Modem_BPSK_fast<B, R, Q>::size_mod(const int N)
{
...
template<typename B, typename R, typename Q>
int
Modem_BPSK_fast<B, R, Q>::size_fil(const int N)
{
