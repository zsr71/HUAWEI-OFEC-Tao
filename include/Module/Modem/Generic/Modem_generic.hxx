...
Modem_generic<B, R, Q, MAX>::Modem_generic(const int N, const tools::Constellation<R>& _cstl, const bool disable_sig2)
  : Modem<B, R, Q>(N,
...
Modem_generic<B, R, Q, MAX>::clone() const
{
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
bool
Modem_generic<B, R, Q, MAX>::is_complex_mod(const tools::Constellation<R>& c)
{
    return c.is_complex();
}
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
bool
Modem_generic<B, R, Q, MAX>::is_complex_fil(const tools::Constellation<R>& c)
{
    return c.is_complex();
}
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
int
Modem_generic<B, R, Q, MAX>::size_mod(const int N, const tools::Constellation<R>& c)
{
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
int
Modem_generic<B, R, Q, MAX>::size_fil(const int N, const tools::Constellation<R>& c)
{
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_modulate(const B* X_N1, R* X_N2, const size_t frame_id)
{
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_tmodulate(const Q* X_N1, R* X_N2, const size_t frame_id)
{
    if (this->cstl.is_complex())
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_demodulate(const float* CP, const Q* Y_N1, Q* Y_N2, const size_t frame_id)
{
    if (*CP != this->last_channel_param && !this->disable_sig2) this->inv_sigma2 = (R)((R)1.0 / (2 * *CP * *CP));
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_demodulate_wg(const float* CP,
                                            const R* H_N,
                                            const Q* Y_N1,
                                            Q* Y_N2,
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_tdemodulate(const float* CP, const Q* Y_N1, const Q* Y_N2, Q* Y_N3, const size_t frame_id)
{
    if (*CP != this->last_channel_param && !this->disable_sig2) this->inv_sigma2 = (R)((R)1.0 / (2 * *CP * *CP));
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_tdemodulate_wg(const float* CP,
                                             const R* H_N,
                                             const Q* Y_N1,
                                             const Q* Y_N2,
                                             Q* Y_N3,
...
Modem_generic<B, R, Q, MAX>::_demodulate_complex(const Q* Y_N1, Q* Y_N2, const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // loop upon the LLRs
    {
        ...
        for (auto j = 0; j < this->nbr_symbols; j++)
            if (((j >> b) & 1) == 0)
                L0 = MAX(
                  L0, -std::norm(complex_Yk - std::complex<Q>((Q)cstl[j].real(), (Q)cstl[j].imag())) * (Q)inv_sigma2);
            else
                L1 = MAX(
                  L1, -std::norm(complex_Yk - std::complex<Q>((Q)cstl[j].real(), (Q)cstl[j].imag())) * (Q)inv_sigma2);
...
Modem_generic<B, R, Q, MAX>::_demodulate_wg_complex(const R* H_N, const Q* Y_N1, Q* Y_N2, const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // loop upon the LLRs
    {
        ...
        for (auto j = 0; j < this->nbr_symbols; j++)
            if (((j >> b) & 1) == 0)
                L0 = MAX(L0,
                         -std::norm(complex_Yk - complex_Hk * std::complex<Q>((Q)cstl[j].real(), (Q)cstl[j].imag())) *
                           (Q)inv_sigma2);
            else
                L1 = MAX(L1,
                         -std::norm(complex_Yk - complex_Hk * std::complex<Q>((Q)cstl[j].real(), (Q)cstl[j].imag())) *
...
Modem_generic<B, R, Q, MAX>::_tdemodulate_complex(const Q* Y_N1, const Q* Y_N2, Q* Y_N3, const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // loop upon the LLRs
    {
        ...
        {
            auto tempL =
              (Q)(std::norm(complex_Yk - std::complex<Q>((Q)cstl[j].real(), (Q)cstl[j].imag())) * (Q)inv_sigma2);
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_tdemodulate_wg_complex(const R* H_N,
                                                     const Q* Y_N1,
                                                     const Q* Y_N2,
                                                     Q* Y_N3,
                                                     const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // loop upon the LLRs
    {
        ...
        {
            auto tempL =
              (Q)(std::norm(complex_Yk - complex_Hk * std::complex<Q>((Q)cstl[j].real(), (Q)cstl[j].imag())) *
                  (Q)inv_sigma2);
...
Modem_generic<B, R, Q, MAX>::_demodulate_real(const Q* Y_N1, Q* Y_N2, const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // loop upon the LLRs
    {
        ...
        for (auto j = 0; j < this->nbr_symbols; j++)
            if (((j >> b) & 1) == 0)
                L0 = MAX(L0, -(Y_N1[k] - (Q)cstl.get_real(j)) * (Y_N1[k] - (Q)cstl.get_real(j)) * (Q)inv_sigma2);
            else
                L1 = MAX(L1, -(Y_N1[k] - (Q)cstl.get_real(j)) * (Y_N1[k] - (Q)cstl.get_real(j)) * (Q)inv_sigma2);
...
Modem_generic<B, R, Q, MAX>::_demodulate_wg_real(const R* H_N, const Q* Y_N1, Q* Y_N2, const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // loop upon the LLRs
    {
        ...
        for (auto j = 0; j < this->nbr_symbols; j++)
            if (((j >> b) & 1) == 0)
                L0 = MAX(L0,
                         -(Y_N1[k] - (Q)H_N[k] * (Q)cstl.get_real(j)) * (Y_N1[k] - (Q)H_N[k] * (Q)cstl.get_real(j)) *
                           (Q)inv_sigma2);
            else
                L1 = MAX(L1,
                         -(Y_N1[k] - (Q)H_N[k] * (Q)cstl.get_real(j)) * (Y_N1[k] - (Q)H_N[k] * (Q)cstl.get_real(j)) *
...
Modem_generic<B, R, Q, MAX>::_tdemodulate_real(const Q* Y_N1, const Q* Y_N2, Q* Y_N3, const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // loop upon the LLRs
    {
        ...
        for (auto j = 0; j < this->nbr_symbols; j++)
        {
            auto tempL = (Q)((Y_N1[k] - cstl.get_real(j)) * (Y_N1[k] - cstl.get_real(j)) * (Q)inv_sigma2);
...
template<typename B, typename R, typename Q, tools::proto_max<Q> MAX>
void
Modem_generic<B, R, Q, MAX>::_tdemodulate_wg_real(const R* H_N,
                                                  const Q* Y_N1,
                                                  const Q* Y_N2,
                                                  Q* Y_N3,
                                                  const size_t /*frame_id*/)
{
    ...
    for (auto n = 0; n < size; n++) // boucle sur les LLRs
    {
        ...
        {
            auto tempL =
              (Q)((Y_N1[k] - (Q)H_N[k] * cstl.get_real(j)) * (Y_N1[k] - (Q)H_N[k] * cstl.get_real(j)) * (Q)inv_sigma2);
