...
template<typename R>
inline R
max_linear(const R a, const R b)
{
...
template<>
inline float
max_star_safe(const float a, const float b)
{
    float d = std::abs(a - b);
...
template<>
inline double
max_star_safe(const double a, const double b)
{
...
template<typename R>
inline mipp::Reg<R>
max_i(const mipp::Reg<R> a, const mipp::Reg<R> b)
{
    return mipp::max(a, b);
}
...
template<typename R>
inline mipp::Reg<R>
max_linear_i(const mipp::Reg<R> a, const mipp::Reg<R> b)
{
...
template<typename R>
inline mipp::Reg<R>
max_star_i(const mipp::Reg<R> a, const mipp::Reg<R> b)
{
...
template<typename R>
inline R
correction_linear2(const R x)
{
    if (x > 2.625)
        return (R)0;
    else if (x < 1.000)
        return (R)-0.3750 * x + (R)0.6825;
    else
        return (R)-0.1875 * x + (R)0.5;
}

template<typename R>
inline R
min_star_linear2(const R a, const R b)
{
...
template<typename R>
inline mipp::Reg<R>
min_i(const mipp::Reg<R> a, const mipp::Reg<R> b)
{
    return mipp::min(a, b);
}
...
template<typename R>
inline mipp::Reg<R>
correction_linear2_i(const mipp::Reg<R> x)
{
...
template<typename R>
inline mipp::Reg<R>
min_star_linear2_i(const mipp::Reg<R> a, const mipp::Reg<R> b)
{
...
template<typename R>
inline mipp::Reg<R>
min_star_i(const mipp::Reg<R> a, const mipp::Reg<R> b)
{
